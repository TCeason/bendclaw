...
CREATE TABLE IF NOT EXISTS channel_accounts (
    ...
    node_id         VARCHAR   NOT NULL DEFAULT '' COMMENT 'Bind to specific bendclaw instance (empty = any)',
    created_by      VARCHAR   NOT NULL DEFAULT '' COMMENT 'User who created this channel account',
