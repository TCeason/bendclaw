...
use open_agent_sdk::types::{self};
use open_agent_sdk::Agent;
use open_agent_sdk::AgentOptions;
use open_agent_sdk::SDKMessage;
...
async fn main() {
    ...
    mcp_servers.insert("filesystem".to_string(), McpServerConfig::Stdio {
