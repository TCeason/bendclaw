...
//!
//! **Internally budget-gated** — returns immediately if under budget.
//!
...
pub struct CollapseOldAssistantTurns;

impl CompactionPass for CollapseOldAssistantTurns {
    fn name(&self) -> &str {
        "CollapseOldAssistantTurns"
    }
