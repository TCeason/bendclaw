...
export const COMMANDS: SlashCommand[] = [
  ...
  { name: '/goal', description: 'Manage long-task goal', usage: '/goal [show | pause | resume | clear] or /goal <objective> [--budget=<tokens>] [--max-iter=<n>] [--timeout=<secs>]', handler: 'builtin' },
